...
Each one is written to be **self-contained** — the receiving tool has never seen `docs/specs/jag-composite-board-design-spec.md`
...
`docs/specs/jag-composite-board-design-spec.md` remains the source of truth. Prompts pull from it selectively —
